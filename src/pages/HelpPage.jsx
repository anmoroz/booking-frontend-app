            ...
            <Box sx={{ flexGrow: 1 }} m={1} p={1}>
                <Paper elevation={2}>
                    <Box sx={{ flexGrow: 1 }} m={1} p={1}>
                        ...
                        <p align="center">
                            <img src="/help/help-rooms1.jpg" alt="Создание объекта размещения" width="98%"/>
                        </p>
                    </Box>
                </Paper>
                <Paper elevation={2} style={{marginTop: '26px'}}>
                    <Box sx={{ flexGrow: 1 }} m={1} p={1}>
                        ...
                        <p align="center">
                            <img src="/help/help-contacts1.jpg" alt="Список контактов" width="98%"/>
                        </p>
                    </Box>
                </Paper>
                <Paper elevation={2} style={{marginTop: '26px'}}>
                    <Box sx={{ flexGrow: 1 }} m={1} p={1}>
                        ...
                        <p align="center">
                            <img src="/help/help-reservations1.jpg" alt="Список бронирований" width="98%"/>
                        </p>
                        <p>
                            Изменение текущего объекта бронирования.
                        </p>
                        <p align="center">
                            <img src="/help/help-reservations2.jpg" alt="Изменение текущего объекта размещения" width="98%"/>
                        </p>
                    </Box>
                </Paper>
                <Paper elevation={2} style={{marginTop: '26px'}}>
                    <Box sx={{ flexGrow: 1 }} m={1} p={1}>
                        ...
                        <p align="center">
                            <img src="/help/help-calendar1.jpg" alt="Календарь" width="98%"/>
                        </p>
                        <p align="center">
                            <img src="/help/help-calendar2.jpg" alt="Редактирование бронирования" width="98%"/>
                        </p>
                    </Box>
                </Paper>
            </Box>
